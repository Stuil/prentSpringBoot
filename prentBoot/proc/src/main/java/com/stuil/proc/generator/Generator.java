package com.stuil.proc.generator;
...
public class Generator {
    ...
    private static DataSourceConfig getDataSourceConfig() {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/test?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC&useSSL=false");
    ...
    private static InjectionConfig getInjectionConfig() {
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/proc/src/main/resources/mapper/" + tableInfo.getEntityName().replace("Entity", "")
